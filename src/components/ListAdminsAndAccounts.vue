...
<div class="elevation-2 mx-10 pa-3 pt-0 rounded">
    <v-layout class="d-flex flex-wrap">
        <v-col cols="2" class="pt-3 d-flex align-center">
            <p class="text-h6">{{route.name === 'system-admins'?  $t('mua.listAdminsAndAccounts.header.admin') : $t('mua.listAdminsAndAccounts.header.account')}} </p>
        </v-col>
        <v-spacer />
        ...
        <v-col cols="2" class="pt-3 d-flex align-center">
          <v-btn variant="outlined" color="info" @click="createAccountDialog.show()">
                {{ route.name === 'system-admins'? $t('mua.listAdminsAndAccounts.createAdminBtn'): $t('mua.listAdminsAndAccounts.createAccountBtn') }}
            </v-btn>
        ...
        <v-col cols="2" class="d-flex align-center ma-0 pa-0">
           <div >
              ...
              <v-card-text class="pt-0">
                <p class="font-weight-medium" >{{ route.name === 'system-admins'? $t('mua.emptyList.inviteFirstAdmin') : $t('mua.emptyList.addFirstAccount')}} </p>
              </v-card-text>
            </div>
        </v-col>
    </v-layout>
          ...
          <v-card class="ma-auto align-self-start elevation-0 text-center" :min-width="filter.length === 0 ? route.name === 'system-admins'?  320 : 280: 400">
            ...
            <v-row class="mt-2" >
               ...
               <v-col cols="10" class="pt-4 ml-0 pl-0">
                 <h3  v-if="filter.length === 0">{{ $t('mua.emptyList.NoElementsYet', {name: route.name === 'system-admins'?  $t('mua.listAdminsAndAccounts.header.admin') : $t('mua.listAdminsAndAccounts.header.account')}) }}</h3>
