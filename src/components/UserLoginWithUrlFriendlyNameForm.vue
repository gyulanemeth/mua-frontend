...
<template>
    <v-form class="d-flex flex-column justify-center align-center h-screen">
        ...
        <v-card class="ma-2 pa-2 rounded-xl elevation-2" width="80%" max-width="600px">
            <v-card-text align="center">
                <h6 class="text-h6">{{ $t('muaAuth.userLoginAndResetForm.loginUrlFriendlyNameHeader', {
                    name:
                ...
                <v-text-field hide-details density="compact" class="my-5 rounded" color="info"
                    ...
                    :placeholder="data.password || $t('muaAuth.userLoginAndResetForm.passwordPlaceholder')" :value="data.password"
                ...
                <div>
                    ...
                    <v-col cols="12" sm="6" class="text-sm-right pr-sm-1 ">
                        <p>{{ $t('muaAuth.userLoginAndResetForm.forgotHeader') }}</p>
                    </v-col>
                ...
                <v-container class="pa-4 my-0 py-0 pl-sm-0 w-100">
                    <v-row no-gutters class="justify-center align-center">
                    <v-col cols="12" sm="6" class="text-sm-right pr-sm-1 ">
                        <p> {{ $t('muaAuth.userLoginAndResetForm.cb.loginToDifferentAccountMessage') }}</p>
                    </v-col>
                    <v-col cols="12" sm="5" class="text-sm-left">
