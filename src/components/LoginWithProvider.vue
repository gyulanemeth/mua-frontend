...
<template>
  <v-card-text align="left">
    ...
    <v-btn block @click="submitLoginWithProvider('google')" class="pa-2 border" variant="text">
      ...
      <span class="mx-2 text-caption font-weight-medium">Sign in with Google</span>
    </v-btn>
    <v-btn block @click="submitLoginWithProvider('microsoft')" class="pa-2 border mt-2" variant="text">
      ...
      <span class="mx-2 text-caption font-weight-medium">Sign in with Microsoft</span>
    </v-btn>
    <v-btn block @click="submitLoginWithProvider('github')" class="pa-2 border mt-2" variant="text">
      ...
      <span class="mx-2 text-caption font-weight-medium">Sign in with Github</span>
    </v-btn>
  </v-card-text>
</template>
