...
import MFALoginForm from './MFALoginForm.vue'
    ...
    <v-layout v-else style="z-index: 10;" class="d-flex flex-column justify-center align-center h-100">
        ...
        <v-container class="w-100">
            <v-col class="text-center justify-center align-center">
                ...
                <router-link data-test-id="login-resetPasswordBtn" style="text-decoration: none; color: #888888;"
                    class="font-weight-bold" to="/system-admins/forgot-password">{{
                        $t('mua.adminLogin.resetPasswordBtn') }}</router-link>
            </v-col>
        </v-container>
    </v-layout>
</template>
